  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto section-padding text-center">
        ...
        <h1 className="mt-8 text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-bold tracking-tight leading-[0.9] animate-slide-up">
          {t.hero.title1}
          <br />
          <span className="text-gradient">{t.hero.title2}</span>
        </h1>

        <p className="mt-8 sm:mt-6 text-base sm:text-xl text-white/50 max-w-2xl mx-auto leading-relaxed animate-fade-in">
          {t.hero.subtitle}
        </p>

        <div className="mt-8 sm:mt-10 flex flex-row flex-wrap items-center justify-center gap-3 animate-slide-up">
          <a
            href="/try-it"
            className="px-4 sm:px-8 py-2.5 sm:py-3.5 rounded-xl bg-gradient-to-r from-mate-500 to-purple-600 hover:from-mate-400 hover:to-purple-500 text-white font-medium text-sm sm:text-lg transition-all shadow-xl shadow-mate-500/30 hover:shadow-mate-500/50 text-center"
          >
            {t.hero.tryNow}
          </a>
          <a
            href="https://github.com/M31i55a/windowsMate-Thuki"
            className="px-4 sm:px-8 py-2.5 sm:py-3.5 rounded-xl border border-white/10 hover:border-white/20 text-white/80 hover:text-white font-medium text-sm sm:text-lg transition-all text-center"
          >
            Source code
          </a>
        </div>
